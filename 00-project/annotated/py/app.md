# langgraphr/inst/server/app.py

<!-- TARGET: langgraphr/inst/server/app.py -->

> FastAPI entry point (`app:app`) for the hidden server: health, agents,
> graphs, tools, threads, runs, resume.
