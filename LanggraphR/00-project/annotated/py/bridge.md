# langgraphr/inst/server/bridge.py

<!-- TARGET: langgraphr/inst/server/bridge.py -->

> Run orchestration shared by the HTTP endpoints: starts runs, detects pending
> interrupts, and returns clean result dicts for R.
